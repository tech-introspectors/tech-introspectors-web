  ...
  return (
    <a href={`#${id}`}>
      <div className="group overflow-hidden relative cursor-pointer rounded-xl shadow-lg flex flex-col justify-center items-center h-40 w-96 md:w-80 bg-white">
        <div className="absolute left-0 top-0 transition-all duration-700 transform group-hover:translate-x-24 overflow-hidden  h-full w-full">
          <img src={src} className="h-full" />
        </div>
        <div className="absolute transition-all duration-700 group-hover:hidden right-2 md:right-0 w-1/2 z-0">
