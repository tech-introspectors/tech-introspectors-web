export const typeOfprojectsData = [
  {
...
export const projectsShowCaseData = [
  {
    mobileAppProjects: [
      ...
      },
      {
        ...
        projectDescription:
          "A mobile banking application in which users can add their credit/debit cards and transfer money to other users.",
      },
      {
        category: "Mobile APP",
        projectDemoLink: "/#",
    ...
    webDevelopmentProjects: [
      {
        ...
        projectDescription:
          "A web application that uses an integrated machine learning model to identify and classify objects.",
      },
      {
        category: "Web Application",
        ...
        projectDescription:
          "A web application that allows users to add their credit/debit cards and transfer money to other users.",
      },
      {
        category: "Web Application",
        projectDemoLink:
        ...
        projectDescription:
          "A web application that keeps track of various emergency supplies and their availability.",
      },
      {
        category: "Web Application",
...

  {
    mlProjects: [
      ...
      },
      {
        ...
        projectDemoLink: "/#",
        projectImgSrc:
          "/images/projectsImg/topProjectImg/facial recogition.png",
        projectName: "Facial recognition in convinience stores",
        projectDescription:
          "A machine learning project that uses a convolutional neural network to recognize faces in convinience stores.",
      },
    ],
  },
];
